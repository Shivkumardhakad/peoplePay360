...
import { useState as useStateLegacy } from "react";
import LinkLegacy from "next/link";
import { useSession as useSessionLegacy } from "next-auth/react";
import { Search as SearchLegacy, Download as DownloadLegacy, ArrowRight as ArrowRightLegacy, Loader2 as Loader2Legacy } from "lucide-react";
import { Button as ButtonLegacy } from "@/components/ui/button";
import { Input as InputLegacy } from "@/components/ui/input";
import { Badge as BadgeLegacy } from "@/components/ui/badge";
import { Table as TableLegacy, TableBody as TableBodyLegacy, TableCell as TableCellLegacy, TableHead as TableHeadLegacy, TableHeader as TableHeaderLegacy, TableRow as TableRowLegacy } from "@/components/ui/table";
import { useToast as useToastLegacy } from "@/components/ui/toast";
import { generatePayslipPDF as generatePayslipPDFLegacy } from "@/lib/payslip-pdf";

const LEGACY_MOCK_PAYSLIPS = [
  {
    id: "PS-1001",
...
function legacyMoney(value: number) {
